...
void main() {
    ...
    float displacementX = (fbm(uv * 10.0 + time) - 0.5) * 0.01; // Adjust the strength as needed
    float displacementY = (fbm(uv * 10.0 + time * 0.5) - 0.01) * 0.1; // Adjust the strength as needed
